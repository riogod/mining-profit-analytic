...
foreach ($hsr[1] as $hsr_key=>$hsr_coin)
{
 ...
 //  print("INSERT INTO coin_prices (coin_name, symbol, reward_per_b, algo) VALUES ('".find_cur_name($hsr_coin, $mysqli)."', '".$hsr_coin."', ".$coin[1].", '".$hsr[2][$hsr_key]."') ON DUPLICATE KEY UPDATE reward_per_b=".$coin[1].'<br>');
    flush();
    ob_flush();
