...
foreach ($results as $symbol => $res)
{
    ...
    //print("INSERT INTO pools_stat (coin_name, symbol, workers, shares, hashrate, estimate, 24h_blocks, timesincelast, pool, algo) VALUES ('".$res['name']."', '".$symbol."', '".$res['workers']."', '".$res['shares']."', '".$res['hashrate']."', '".$res['estimate']."', '".$res['24h_blocks']."', '".$res['timesincelast']."', '".$pool_name."', '".$res['algo']."')<br>");
